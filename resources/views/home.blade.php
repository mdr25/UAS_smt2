    ...
    <div class="container">
        <div class="row">
            ...
            @foreach ($produks as $produk)
                <div class="modal fade" id="productView{{ $produk->id }}" tabindex="-1">
                                ...
                                <div class="row align-items-stretch">
                                    <div class="col-lg-6 p-lg-0">
                                        <a class="glightbox product-view d-block h-100 bg-cover bg-center"
                                            style="background: url({{ url('img') }}/{{ $produk->foto }})"
                                            href="{{ url('pesan') }}/{{ $produk->id }}" data-gallery="gallery1"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-4 my-md-4">
                                            ...
                                            <p class="text-muted">Rp {{ number_format($produk->harga) }}</p>
                    ...
                    <div class="container py-5">
                        <div class="row px-4 px-lg-5">
                            <div class="col-lg-6">
                                ...
                                <h1 class="h2 text-uppercase mb-3">100% off on new season</h1><a class="btn btn-dark"
                                ...
                                <div class="product text-center">
                                    <div class="position-relative mb-3">
                                        <div class="badge text-white bg-"></div><a class="d-block"
                                            href="{{ url('pesan') }}/{{ $produk->id }}"><img class="img-fluid w-100"
                                                src="{{ url('img') }}/{{ $produk->foto }}" alt="..."></a>
                                            ...
                                            <ul class="mb-0 list-inline">
                                                ...
                                                <li class="list-inline-item me-0">
                                                    <a class="btn btn-sm btn-outline-dark"
                                                        href="#productView{{ $produk->id }}" data-bs-toggle="modal">
                                    ...
                                    <h6> <a class="reset-anchor" href="detail.html">{{ $produk->nama }}</a></h6>
                                    <p class="small text-muted">Rp {{ number_format($produk->harga) }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
